...
- **Cuenta**: cambiar tu propia contraseña, y crear usuarios adicionales
  (todos con las mismas capacidades) para que más de una persona pueda
  administrar la carta con su propio usuario.
...
el mismo mecanismo que la carta (Redis o archivo local), y las contraseñas
nunca se guardan en texto plano — se guarda un hash.
